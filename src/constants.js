...
export const EVA_PHASES = ["ADN Comercial", "Capacitación", "Coaching y WBR"];

export const SBOS_PHASES = [
...
export const STATUSES          = ["Pendiente", "En progreso", "Completado", "Reagendado"];
export const MODALITIES        = ["Presencial", "En línea", "Híbrida"];
export const INTERACTION_TYPES = ["Interna", "Con cliente"];
export const RECURRENCE_OPTIONS= ["No se repite", "Semanal", "Quincenal", "Mensual"];
...
export const SHEETS_URL = "https://script.google.com/macros/s/AKfycbyEtzxG6d05b2dyFLdWW1xI-DoPtSp-XiUKxK_HXLCnhKyDYQPcNFzk2MSkxkiNxy1d/exec";
